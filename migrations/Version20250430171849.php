 ...
 */
final class Version20250430171849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD mot_de_passe VARCHAR(255) NOT NULL, DROP mp, CHANGE id_role_id role_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD mp VARCHAR(8) NOT NULL, DROP mot_de_passe, CHANGE role_id id_role_id INT DEFAULT NULL');
